...
func TestOutputDescriptor(t *testing.T) {
	...
	tests := []struct {
		...
		{
			&bip380.Descriptor{
				Script: bip380.P2WPKH, Threshold: 1, Keys: []bip380.Key{
					{
						Network:           &chaincfg.MainNetParams,
						MasterFingerprint: 0x9c43e6c2,
						DerivationPath:    bip32.Path{hdkeychain.HardenedKeyStart + 84, hdkeychain.HardenedKeyStart, hdkeychain.HardenedKeyStart},
		...
		{
			&bip380.Descriptor{
				Script: bip380.P2SH_P2WPKH, Threshold: 1, Keys: []bip380.Key{
					{
						Network:           &chaincfg.MainNetParams,
						MasterFingerprint: 0x9866232b,
						DerivationPath:    bip32.Path{hdkeychain.HardenedKeyStart + 49, hdkeychain.HardenedKeyStart, hdkeychain.HardenedKeyStart},
		...
		{
			&bip380.Descriptor{
				Script: bip380.P2PKH, Threshold: 1, Keys: []bip380.Key{
					{
						Network:           &chaincfg.MainNetParams,
						MasterFingerprint: 0x9866232b,
						DerivationPath:    bip32.Path{hdkeychain.HardenedKeyStart + 44, hdkeychain.HardenedKeyStart, hdkeychain.HardenedKeyStart},
		...
		{
			&bip380.Descriptor{
				Script: bip380.P2TR, Threshold: 1, Keys: []bip380.Key{
					{
						Network:           &chaincfg.MainNetParams,
						MasterFingerprint: 0x9866232b,
						DerivationPath:    bip32.Path{hdkeychain.HardenedKeyStart + 86, hdkeychain.HardenedKeyStart, hdkeychain.HardenedKeyStart},
	...
	for _, test := range tests {
		got := EncodeDescriptor(test.desc)
