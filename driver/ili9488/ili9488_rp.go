...
func (d *Device) Configure(c Config) error {
	...
	if !ips {
		...
		// IPS + CPS.
		initCmd = []byte{
			0xE0, 15, 0x00, 0x08, 0x0C, 0x02, 0x0E, 0x04, 0x30, 0x45, 0x47, 0x04, 0x0C, 0x0A, 0x2E, 0x34, 0x0F,
			0xE1, 15, 0x00, 0x11, 0x0D, 0x01, 0x0F, 0x05, 0x39, 0x36, 0x51, 0x06, 0x0F, 0x0D, 0x33, 0x37, 0x0F,
			0xC0, 2, 0x0f, 0x0f,
			0xC1, 1, 0x41,
			0xC2, 1, 0x22,
